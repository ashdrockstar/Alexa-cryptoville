...
var farms = {
    "apple": {
        "personality_trait": "sweet and healthy",
        "price" : "$10",
    "state" : "NY"
},
    "apricot": {
...
function getWelcomeResponse(callback) {
    ...
    const speechOutput = 'Welcome to the CryptoVille Farms. Purchase everything within your cryptoBudget.' +
        'We have Apples, Oranges, Bananas and many more. Dont miss out the opportunity.';
...
function SetProduceIntent(intent, session, callback) {
    ...
    let speechOutput = '';
    if(farms[farm]){
    speechOutput = `Sharing information about ${farm}. Personality_trait, ${farms[farm].personality_trait}. Current Price, ${farms[farm].price}. Available in ${farms[farm].state} state.`;
